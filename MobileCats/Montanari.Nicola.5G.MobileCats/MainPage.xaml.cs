...
namespace Montanari.Nicola._5G.MobileCats
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        async void Aggiorna()
        {
            List<RootObject> cats = new List<RootObject>(); 
            List<RootObject> cats2 = new List<RootObject>();
            ...
            try
            {
                ...
                for (int cnt = 0; cnt < 10; cnt++)
                {
                    ...
                    cats = JsonConvert.DeserializeObject<List<RootObject>>(response);
                    cats2.Add(cats[0]);
                }
